...
namespace Core.Migrations
{
    ...
    [Migration("20231102120125_AddNewValueToLeaveSetup")]
    partial class AddNewValueToLeaveSetup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.LeaveApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.LeaveSetup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("FaceImageData")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Models.Attendance", b =>
                {
                    ...
                    b.HasOne("Core.Models.ApplicationUser", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.LeaveApplication", b =>
                {
                    b.HasOne("Core.Models.LeaveSetup", "Leave")
                        .WithMany()
